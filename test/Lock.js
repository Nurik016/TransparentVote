...
describe("MyLock", function () {
  ...
  describe("Withdrawals", function () {
    describe("Validations", function () {
      it("Should revert with the correct error if called too soon", async function () {
      ...
      it("Should revert with the correct error if called from another account", async function () {
